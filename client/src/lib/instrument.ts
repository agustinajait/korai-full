...
export interface Indicator {
  ...
  soloSiNinos?: boolean;
  // Tipo de vivienda requerido para mostrar este indicador
  soloSiVivienda?: string[];
}

export const INSTRUMENT = {
  dimensions: [
    { id: "empleo",    name: "Empleo",        emoji: "💼", description: "Trabajo y condiciones laborales" },
    { id: "prevision", name: "Ingresos",       emoji: "🧾", description: "Situacion economica y respaldo financiero" },
  ...
  indicators: [
    ...
    { id: "empleo_07", dimension: "empleo", label: "Tengo un oficio o experiencia que puedo usar para conseguir trabajo o changas", soloSi: "no_tengo_trabajo" },
    { id: "empleo_08", dimension: "empleo", label: "Hoy puedo empezar a trabajar si surge algo — tengo tiempo, cuidados resueltos y documentacion en orden", soloSi: "no_tengo_trabajo", invert: true },

    // ─── PREVISIÓN ─────────────────────────────────────────────────────────────
    { id: "prevision_01", dimension: "prevision", label: "Si aparece un gasto urgente, puedo resolverlo sin quedar muy endeudado/a" },
    { id: "prevision_02", dimension: "prevision", label: "Puedo organizarme para saber en qué se va la plata cada mes" },
    { id: "prevision_03", dimension: "prevision", label: "Mis deudas no me ahogan — las puedo pagar o directamente no tengo" },
    { id: "prevision_04", dimension: "prevision", label: "Tengo cuenta bancaria o billetera virtual (Mercado Pago, Naranja X, etc.)" },
    { id: "prevision_05", dimension: "prevision", label: "Puedo manejar mi propio dinero sin que nadie me lo controle o quite" },
    { id: "prevision_06", dimension: "prevision", label: "Puedo pagar o sostener los gastos del hogar" },
    ...
    { id: "vivienda_04", dimension: "vivienda", label: "En mi hogar hay espacio suficiente para que todos duerman y convivan bien" },
    ...
    { id: "vivienda_08", dimension: "vivienda", label: "Tengo un espacio donde puedo estar solo/a cuando lo necesito" },

    // ─── SALUD ────────────────────────────────────────────────────────────────
    { id: "salud_01", dimension: "salud", label: "Puedo alimentarme bien todos los días, no solo lo que se puede" },
    { id: "salud_02", dimension: "salud", label: "Cuando me enfermo puedo ir al medico sin mayores problemas" },
    { id: "salud_03", dimension: "salud", label: "Puedo conseguir los medicamentos que necesito" },
    { id: "salud_04", dimension: "salud", label: "No tengo turnos medicos o tratamientos pendientes que este postergando" },
    { id: "salud_05", dimension: "salud", label: "Mis dientes estan bien — no me duelen ni me limitan para comer o hablar" },
