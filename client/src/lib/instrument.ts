...
export const INSTRUMENT = {
  ...
  indicators: [
    ...
    { id: "prevision_03", dimension: "prevision", label: "Tengo deudas que hoy no puedo pagar", invert: true },
    ...
    { id: "vivienda_08", dimension: "vivienda", label: "Comparto vivienda con otra familia porque no queda otra opción", invert: true },
    ...
    { id: "salud_04", dimension: "salud", label: "Tengo alguna enfermedad, dolor o tratamiento que estoy postergando", invert: true },
    { id: "salud_05", dimension: "salud", label: "Tengo problemas dentales que me dificultan comer, hablar o trabajar", invert: true },
