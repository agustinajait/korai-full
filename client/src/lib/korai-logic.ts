...
const RECURSOS_MUNICIPALES: Record<string, { nombre: string; descripcionCorta?: string; url?: string; telefono?: string; accion?: string; tipo?: "publico" | "privado" | "ong" }[]> = {
  empleo: [
    ...
    },
    {
      ...
      descripcionCorta: "Creá tu perfil, sumá habilidades y conectate con empleadores.",
    ...
    },
    {
      ...
      descripcionCorta: "Beca 100% gratuita para jóvenes de 18 a 24 años. Formación en habilidades laborales y empleabilidad. Inscripción online.",
      url: "http://inscripcion.fundacionforge.org",
      accion: "Inscribirme a la beca", tipo: "ong",
    },
    {
      nombre: "Junior Achievement — Planificá tu futuro",
      descripcionCorta: "Programa gratuito para jóvenes de 16 a 25 años. Orientación laboral, CV y LinkedIn. 100% online, 3 semanas.",
      url: "https://junior.org.ar/planificatufuturo/",
      accion: "Inscribirme gratis", tipo: "ong",
    },
    {
      nombre: "Google Career Certificates — Cursos gratuitos",
  ...
  educacion: [
    ...
    {
      nombre: "Argentina Programa — Cursos IT gratuitos",
      descripcionCorta: "Programa del Estado con cursos gratuitos de programación y tecnología para cualquier persona.",
    ...
    {
      nombre: "Junior Achievement — Cursos en alianza con el Estado",
  ...
  vivienda: [
    ...
    {
      nombre: "Banco Nación — Crédito Argenta",
      descripcionCorta: "Créditos para mejoras del hogar a tasa preferencial para jubilados y beneficiarios de ANSES.",
  ...
  prevision: [
    ...
    {
      nombre: "CAME — Microcréditos para emprendedores",
      descripcionCorta: "La Confederación Argentina de la Mediana Empresa ofrece microcréditos para pequeños emprendedores.",
