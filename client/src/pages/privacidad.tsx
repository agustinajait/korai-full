export default function Privacidad() {
  return (
    <div style={{ minHeight: "100vh", background: "#F4F0FF", color: "#1E1040", padding: "40px 20px", maxWidth: "700px", margin: "0 auto" }}>
      ...
      <p>KORAI es una aplicacion de diagnostico de bienestar comunitario.</p>
      <h2 style={{ color: "#5B21B6" }}>2. Informacion que recopilamos</h2>
      <p>DNI encriptado, numero de WhatsApp opcional, nombre, barrio, edad, situacion laboral y respuestas al diagnostico.</p>
      <h2 style={{ color: "#5B21B6" }}>3. Como usamos tu informacion</h2>
      <p>Para generar tu plan personalizado y mejorar los servicios comunitarios.</p>
